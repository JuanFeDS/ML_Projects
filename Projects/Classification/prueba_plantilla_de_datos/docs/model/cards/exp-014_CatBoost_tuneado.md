# Model Card — Exp-014 | CatBoost (tuneado)
...
- **val_accuracy este run:** 0.8285

- **val_accuracy referencia:** 0.8227

- **Diferencia:** +0.0058

- **Artefacto:** models/experiments/exp-014_CatBoost_tuneado.pkl
...
| Metrica               |   Valor |
|:----------------------|--------:|
| Accuracy (validacion) |  0.8285 |
| ROC-AUC (validacion)  |  0.9072 |
