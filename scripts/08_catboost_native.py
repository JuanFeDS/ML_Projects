...
from src.models.catboost_native import make_pool, oof_proba, tune
...
def main() -> None:
    ...
    if params_cache.exists():
        ...
        best_params = tune(x, y, cv, args.n_iter, study_db)
    ...
    save_metadata(
        {"exp_id": exp_id, "model": "CatBoost_native", "cat_features": CAT_FEATURES,
         "numeric_features": NUMERIC_FEATURES_NATIVE, "feature_names": ALL_FEATURES_NATIVE,
         "oof_acc": oof_acc, "oof_acc_with_threshold": thr_acc,
         "oof_roc_auc": oof_roc, "threshold": threshold, "best_params": best_params,
         "n_train_samples": len(x)},
        exp_id, "catboost_native",
    )
