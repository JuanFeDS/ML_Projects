"""
Feature engineering especifico para Spaceship Titanic.

Cada funcion transforma el DataFrame sin mutar el input (siempre df.copy()).
Las funciones son aditivas: nunca se borran, solo se anaden nuevas.
La justificacion estadistica de cada transformacion viene del analisis en NB02.
"""
